...
$cfg['DefaultTabServer']      = 'index.php'; // original value: main.php
                                   // Possible values:
 ...
 */
$cfg['UploadDir']             = 'uploads';         // Directory for uploaded files that can be executed by
...
$cfg['TempDir']               = '/Applications/MAMP/tmp/phpMyAdmin';
