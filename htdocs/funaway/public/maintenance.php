...
<body>
	<div class="construction-message">
		<div class="logo"><img src="http://demo.fun-away.com/images/logo.png" alt=""></div>
...
<g id="small">
  ...
  <animateTransform 
		...
		<h2>We are restoring database as a scheduled process. <br>Please try in about a minute.</h2>
	</div>
	<p class="footer">© 2018 Funaway Inc. All Rights Reserved.</p>
</body>
