<?php
class OmiseSettingsController extends AdminBaseController
{
	...
	{
		$frm = new Form('OmiseSettingsFrm');
		$frm->addRequiredField('Public Key', 'omise_public_key');
		$frm->addRequiredField('Secrate Key', 'omise_secret_key');
		$frm->addSelectBox('Transaction Mode','omise_transaction_mode',array(0=>"Test/Sandbox",1=>"Live"))->requirements()->setRequired();
