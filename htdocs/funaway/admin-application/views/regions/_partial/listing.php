...
$arr_flds = array(
    'listserial' => 'Sr no.',
    'region_name' => 'Name',
    'region_active' => 'Status',
    'action' => 'Action',
);
if (!$canEdit) {
    unset($arr_flds['action']);
}
$tbl = new HtmlElement('table', array('width' => '100%', 'class' => 'table table-responsive', 'id'=>'regions-list'));
...
foreach ($arr_listing as $sn => $row) {
    $sr_no++;
    $tr = $tbl->appendElement('tr', array("id" => $row['region_id']));
        ...
        switch ($key) {
            ...
            case 'action':
                ...
                if ($canEdit) {
                    ...
                    $li->appendElement('a', array('href' => "javascript:;", 'class' => 'button small green', 'title' => 'Edit', "onclick" => "getForm(" . $row['region_id'] . ")"), '<i class="ion-edit icon"></i>', true);
                }
