...
<table width='100%' class='table table-responsive'>
    ...
    if($records['numMessages']>0){
	?>
    <tr>
        <td>Replies</td>
        <td><a href='Javascript:popupView("<?php echo FatUtility::generateUrl('reviews', 'viewReviewMessages', array('review_id' => $records['review_id'])); ?>")'>Click here to view all replies</a></td>
    </tr>
    <?php } ?>
</table>