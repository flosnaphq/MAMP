            ...
            foreach ($arr_flds as $key => $val) {
                ...
                switch ($key) {
                    ...
                    case 'actions':
						...
						if($canEdit) {
							$li->appendElement('a', array('href' =>  FatUtility::generateUrl('blogcategories', 'form', array($row['category_id'],$category_parent)), 'title' => 'Edit'), '<i class="ion-edit icon"></i>', true);
						}
