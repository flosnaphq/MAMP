...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
		var base = "/user-uploads/backend"; /*Relative to Root*/
		var readonly = false;
        var fullpath = false;
        ...
        function renderTree(bPreview) {
            ...
            $('#container_id').fileTree({
				...
				if ($.inArray(ext, ['gif', 'png', 'jpg', 'jpeg','svg']) != -1) {
                    $("#preview_id").html("<table><tr><td><a id='idFile' href='" + file + "' target='_blank' rel='"+base+"/"+filename+"'><img id='imgFile' src='" + file + "' style='width:70px;padding:4px;border:#cccccc 1px solid;background:#ffffff;margin-bottom:3px' /></a></td><td style='padding-left:20px;width:100%;text-align:left;'>" + filename + "<br /><a id='lnkDelFile' style='font-weight:normal;font-size:10px;color:#c90000;word-spacing:2px;white-space:nowrap;' href='javascript:deleteFile()'>DELETE FILE</a></td></tr></table>");
