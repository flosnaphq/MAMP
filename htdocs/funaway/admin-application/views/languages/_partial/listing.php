				...
				foreach ($arr_flds as $key=>$val){
					...
					switch ($key){
						case 'listserial':
							...
							break;
						case 'flag':
							$td->appendElement('img', array("width"=>"50",'height'=>'50','src'=>FatUtility::generateUrl('image','flag',array($row['language_id'],50,50),CONF_BASE_DIR)));
							break;
						...
						case 'action':
							...
							if($canEdit){
								...
								$li->appendElement('a', array('href'=>"javascript:;", 'class'=>'button small green', 'title'=>'Edit',"onclick"=>"getForm(".$row['language_id'].")"),'<i class="ion-edit icon"></i>', true);	
							}
