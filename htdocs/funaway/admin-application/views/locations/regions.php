                  ...
                  <div class="col-sm-12">  
					...
					<section class="section searchform_filter">
						...
						<div class="sectionbody togglewrap space" style="overflow: hidden; display: none;">
							...
							<?php 
								$search->setFormTagAttribute ( 'onsubmit', 'searchForm(this,"'.$city_id.'"); return(false);');
					...
					<section class="section">
                        <div class="sectionhead">
							...
							<?php if($canEdit){ ?>
							<a href="javascript:;" onclick="getForm('<?php echo $city_id;?>');return;"  class="themebtn btn-default btn-sm">
                               Add New
                            </a>
							<?php } ?>
                        </div>
