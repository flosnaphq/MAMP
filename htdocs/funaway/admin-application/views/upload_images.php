<div id="elem_main_image_div">
    <div class="fieldadd" id="image_div" >
        <div class="grid_1">
            <div class="filefield">
                <span class="filename file_input_name" >Image Size Should be 2000x500px </span>
...
<div id="clone_image_div" style="display:none;">
    <div class="fieldadd"  >
        <div class="grid_1">
            <div class="filefield"><span class="filename file_input_name">Image Size Should be 2000x500px  </span>
                <input type="file" name="post_image_file_name[]" onChange="setFileInputName(this)"><label class="filelabel">Browse File</label>
            </div>
        </div>
        <div class="grid_2">
            <ul class="actions">
