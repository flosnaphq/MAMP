        ...
        switch ($key) {
            ...
            case 'action':
                ...
                if ($canEdit) {
                    ...
                    $li->appendElement('a', array('href' => FatUtility::generateUrl("host", "edit", array($row['user_id'])), 'class' => 'button small green', 'title' => 'View Details'), '<i class="ion-edit icon"></i>', true);
                }
