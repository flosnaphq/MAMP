        ...
        switch ($key) {
            ...
            case 'action':
                ...
                if ($canEdit) {
                    ...
                    $li->appendElement('a', array('href' => FatUtility::generateUrl('countries','setup',array($row['country_id'])), 'class' => 'button small green', 'title' => 'Edit'), '<i class="ion-edit icon"></i>', true);
                }
