...
listing = function(page){
	...
	moveToTop();
	fcom.ajax(fcom.makeUrl('advertisements', 'request-lists', [page]), data, function(json) {
			json = $.parseJSON(json);
			if("1" == json.status){
...
search = function(form){
	...
	fcom.ajax(fcom.makeUrl('advertisements', 'request-lists'), fcom.frmData(form), function(json) {
			json = $.parseJSON(json);
			if("1" == json.status){
				$("#listing").html(json.msg);
				$('#clearSearch').show();
