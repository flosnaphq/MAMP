				...
				foreach ($arr_flds as $key=>$val){
					...
					switch ($key){
						...
						case 'action':
							...
							if($canView){
								$li = $ul->appendElement("li");
								$li->appendElement('a', array('href'=>'Javascript:popupView("'.FatUtility::generateUrl('email-template','view',array('tpl_id'=>$row['tpl_id'])).'");', 'class'=>'button small green', 'title'=>'View detail'),'<i class="ion-eye icon"></i>', true);	
							}
							break;
						default:
