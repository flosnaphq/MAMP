<?php 
	...
	$frm->setFormTagAttribute('action', FatUtility::generateUrl('review','replyToReview'));
	$frm->setFormTagAttribute('id', 'replyToReviewFrm');
	$frm->setValidatorJsObjectName('rvalidate');
	$frm->setFormTagAttribute('onsubmit', 'submitReplyToReview(rvalidate); return(false);');
...
<div class="modal share-card text--center">
	<div class="modal__header">
		<h6 class="modal__heading">Write your reply</h6>
	</div>
