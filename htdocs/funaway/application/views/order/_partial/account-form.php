...
$frm->setFormTagAttribute('onsubmit','updateProfile(orderProfileFrm, this); return false;');
$frm->setValidatorJsObjectName('orderProfileFrm');
...
<h6 class="sub-heading-text text--center text--primary"><?php echo Info::t_lang('KINDLY_INPUT_YOUR_LOGIN_DETAILS')?></h6>
<hr>
