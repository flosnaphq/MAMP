...
$frm->setFormTagAttribute('action',FatUtility::generateUrl('order','setupEmail'));
...
$frm->setFormTagAttribute('onsubmit','orderEmail(orderEmailFrm, this); return false;');
$frm->setValidatorJsObjectName('orderEmailFrm');
...
<h6 class="sub-heading-text text--center text--primary"><?php echo Info::t_lang('KINDLY_INPUT_YOUR_EMAIL')?></h6>
<hr>
