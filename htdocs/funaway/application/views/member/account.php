...
<img src="<?php echo FatUtility::generateUrl('user', 'photo', array($data['user_id'], 100, 100)); ?>">
<form method="post" enctype="multipart/form-data" action="<?php echo FatUtility::generateUrl('member', 'updatePhoto') ?>">
