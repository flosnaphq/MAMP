...
$frm->setFormTagAttribute('action',FatUtility::generateUrl('host','setupBankAccount'));
$frm->setFormTagAttribute('onsubmit','updateBankDetails(bankUpdateFrmValidator, this); return false;');
$frm->setValidatorJsObjectName('bankUpdateFrmValidator');
