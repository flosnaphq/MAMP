...
( function( $ ) {
	...
	var Modaal = {
		...
		create_video : function(url) {
			...
			var modaal_image_markup = '';
			var gallery_total;
			var prev_btn = '<button type="button" class="modaal-gallery-control modaal-gallery-prev" id="modaal-gallery-prev" aria-label="Previous Video (use left arrow to change)"><span>Previous Video</span></button>';
			var next_btn = '<button type="button" class="modaal-gallery-control modaal-gallery-next" id="modaal-gallery-next" aria-label="Next Video (use right arrow to change)"><span>Next Video</span></button>';
			...
			if ( self.$elem.is('[rel]')) {
				...
				for (var i = 0; i < gallery.length; i++) {
					...
					videocontent = '<iframe  data-src="' + gallery[i].url + '"  src="' + gallery[i].url + '" class="modaal-video-frame" frameborder="0" allowfullscreen></iframe>';
					// for each item build up the markup
					modaal_image_markup += '<div class="modaal-gallery-item gallery-item-' + i + is_active + '">' +
						videocontent +
				...
				// Setup selected image
				var this_img_src = self.$elem.attr('href');
				content = '<iframe src="' + this_img_src + '" class="modaal-video-frame" frameborder="0" allowfullscreen></iframe>';
			}
