            ...
            <?php foreach ($images as $img) { ?> 
                <li class="gallery__item thumb__item">
                    ...
                    <div class="buttons__group">
                        <a href='javascript:;' ng-click='removeAddonImage(<?php echo $img['afile_id'] ?>)' class="button button--small button--fill button--red thumb__delete"><?php echo $delete ?></a></div>
    ...
    <div class="field-set">
        ...
        <div class="field-wraper">
            <div class="field_cover">
                ...
                <a class="button button--fill button--dark " ng-click="reloadMe();">Back</a>
            </div>
        </div>
    </div>
</div>
